...
from STDM.DFFM.tools import EarlyStopping, adjust_learning_rate
from STDM.utils.data_processing import split_before
...
from STDM.models.ABS_stdm_model import STDMModel
from STDM.models.model_base import ModelBase, BatchMaker
...
class STDM(ModelBase):
    ...
    def forecast_fit(self, train_valid_data: pd.DataFrame, train_ratio_in_tv: float) -> "ModelBase":
        ...
        self.model = STDMModel(self.config)
