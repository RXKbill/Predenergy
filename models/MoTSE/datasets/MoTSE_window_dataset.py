...
from MoTSE.datasets.ts_dataset import TimeSeriesDataset


class MoTSEWindowDataset:
    """
    ...
    Example:
        ...
        >>> context_length = 10
        >>> prediction_length = 5
        >>> window_dataset = MoTSEWindowDataset(dataset, context_length, prediction_length)
...
class UniversalMoTSEWindowDataset:
    """
